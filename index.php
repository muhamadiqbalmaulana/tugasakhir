...
?>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li><a href="signup">Daftar <span class="glyphicon glyphicon-user"></span><span class="sr-only">(current)</span></a></li>
      </ul>
...
<div class="container bg-success" id="content">
 <h1 class="text-primary text-center"> Lowongan Tersedia </h1>
<?php
	while($row=mysqli_fetch_assoc($result)){

 ?>
	<div class="well bg-info">
  <h4><strong>Nama Pemilik Perusahaan: </strong><?php echo $row['employer']; ?></h4>
    ...
    <p><strong>Tanggal Selesai: </strong><?php echo $row['end_date']; ?></p>
		<a role="button" href="login" class="btn btn-block btn-success">Ajukan</a>
	</div>
	<?php 
	}
	mysqli_close($conn);
