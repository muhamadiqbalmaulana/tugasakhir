...
?>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
     ...
     <ul class="nav navbar-nav navbar-right">
        <li><a href="logout"><span class="glyphicon glyphicon-tasks"></span> Keluar</a></li>
      </ul>
    </div><!-- /.navbar-collapse -->
  </div><!-- /.container-fluid -->
</nav>
<div class="alert alert-success alert-dismissible" role="alert">
  ...
  <strong>Hello!</strong> Selamat Datang <?php echo $usname; ?>
</div>
<div class="container bg-success" id="content">
 <h1 class="text-primary text-center"> Lowongan yang tersedia </h1>
<?php
 ...
 ?>
  ...
  <h4><strong>Nama Pemilik Perusahaan: </strong><?php echo $row['employer']; ?></h4>
    ...
    <p><strong>Tanggal Selesai: </strong><?php echo $row['end_date']; ?></p>
		<a role="button" href="register_intern?employer=<?php echo $row['employer']?>&title=<?php echo $row['title'] ?>" class="btn btn-block btn-success">Ajukan</a>
	</div>
	<?php 
	}
	mysqli_close($conn);
