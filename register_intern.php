...
$query2="SELECT * FROM login WHERE username='$usname'";
...
<div class="jumbotron" style="width:70%; margin:0 auto;">
  ...
  <p class="text-info" style="font-size: 40px;"> Menlamar Untuk Lowongan </p>
...
<input type="hidden" name="title" value="<?php echo $row['title']; ?>">
  <div class="form-group">
    ...
    <div class="col-sm-8">
      <input type="text" name="name" class="form-control" id="inputEmail3" value="<?php echo $rowz['name']; ?>">
    </div>
  </div>
   <div class="form-group">
    <label class="col-sm-2 control-label">Email: </label>
    <div class="col-sm-8">
      <input type="text" name="email" class="form-control" id="inputEmail3" value="<?php echo $rowz['email']; ?>">
    </div>
  </div>
   <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
      <input type="text" name="prodi" class="form-control" id="inputEmail3" value="<?php echo $rowz['prodi']; ?>">
    </div>
  </div>
  <div class="form-group">
    <label class="col-sm-2 control-label">IPK:</label>
    <div class="col-sm-8">
      <input type="text" name="ipk" class="form-control" id="inputEmail3" placeholder="Isikan Indeks Prestasi Kumulatif">
    </div>
  </div>
